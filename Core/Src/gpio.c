...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, MPU6050_AD0_Pin|GPIO_PIN_8, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MPU6050_AD0_Pin PA8 */
  GPIO_InitStruct.Pin = MPU6050_AD0_Pin|GPIO_PIN_8;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
